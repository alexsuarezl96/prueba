...
public class Employee {
    ...
    /*@ManyToOne
    @JoinColumn(name = "idProfile", nullable = false, foreignKey = @ForeignKey(name = "fk_profile"))
    ...
    @ManyToOne
    @JoinColumn(name = "idTransaction",nullable = false, foreignKey =@ForeignKey(name = "fk_transaction"))
